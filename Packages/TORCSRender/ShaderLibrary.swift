...
public struct ShaderLibrary {
    ...
    public static let sourceOrder = ["Common", "BRDF", "Post", "Exposure", "Atmosphere", "Shadow", "Forward", "Sky", "Occlusion", "Reflections", "MotionBlur", "Bloom", "Particles", "SkidMarks", "DepthOfField", "Resolve"]
