...
public struct ShaderLibrary {
    ...
    public static let sourceOrder = ["Common", "BRDF", "Post", "Atmosphere", "Shadow", "Forward", "Sky", "Occlusion", "Reflections", "MotionBlur", "Bloom", "Particles", "SkidMarks", "DepthOfField", "Resolve"]
